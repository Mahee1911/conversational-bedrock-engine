...
from core.agent_factory import create_agent, create_bedrock_model, create_conversation_manager
from tools import visual_tool
from tools.kb_tools import make_kb_tool
...
async def stream_chat_session(body: ChatSessionRequest):
        ...
        #Agent config for model parameter like model id temprature,max token etc.. 
